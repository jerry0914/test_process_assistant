...
final class FileFormatType {
	...
	const EXCEL_2007_XLSB = 16;
	const EXCEL_2007_XLSM = 7;
	const EXCEL_2007_XLSX = 6;
	const EXCEL_2007_XLTM = 9;
	const EXCEL_2007_XLTX = 8;
	const EXCEL_3 = 24;
	const EXCEL_4 = 23;
	const EXCEL_95 = 22;
...
final class LoadDataFilterOptions {
	...
	const DOCUMENT_PROPERTIES = 128;
	const FORMULA = 64;
	const MERGED_AREA = 1024;
	const NONE = 0;
	const PIVOT_TABLE = 8192;
	const SETTINGS = 32768;
	const SHAPE = 512;
	const STYLE = 32;
	const TABLE = 16384;
};
...
final class PasteType {
	...
	const VALIDATION = 10;
	const VALUES = 11;
	const VALUES_AND_NUMBER_FORMATS = 12;
};
...
final class StyleModifyFlag {
	...
	const ALL = 0;
	const BACKGROUND_COLOR = 35;
	const BORDERS = 1;
	const BOTTOM_BORDER = 5;
	const CELL_SHADING = 32;
	const DIAGONAL = 8;
	const DIAGONAL_DOWN_BORDER = 9;
	const DIAGONAL_UP_BORDER = 10;
	const FONT = 11;
	const FONT_CAP = 46;
	const FONT_CHARSET = 15;
	const FONT_COLOR = 16;
	const FONT_DIRTY = 40;
	const FONT_EQUALIZE = 45;
	const FONT_FAMILY = 14;
	const FONT_ITALIC = 18;
	const FONT_KERNING = 44;
	const FONT_NAME = 13;
	const FONT_SCHEME = 39;
	const FONT_SCRIPT = 23;
	const FONT_SIZE = 12;
	const FONT_SPACING = 43;
	const FONT_SPELLING_ERROR = 41;
	const FONT_STRIKE = 20;
	const FONT_SUBSCRIPT = 21;
	const FONT_SUPERSCRIPT = 22;
	const FONT_U_FILL_TX = 42;
	const FONT_UNDERLINE = 19;
	const FONT_WEIGHT = 17;
	const FOREGROUND_COLOR = 34;
	const HIDE_FORMULA = 37;
	const HORIZONTAL_ALIGNMENT = 25;
	const HORIZONTAL_BORDER = 6;
	const INDENT = 27;
	const LEFT_BORDER = 2;
	const LOCKED = 36;
	const NUMBER_FORMAT = 24;
	const PATTERN = 33;
...
final class TextAlignmentType {
	const BOTTOM = 0;
	const CENTER = 1;
	const CENTER_ACROSS = 2;
	const DISTRIBUTED = 3;
	const FILL = 4;
	const GENERAL = 5;
	const JUSTIFIED_LOW = 10;
	const JUSTIFY = 6;
	const LEFT = 7;
	const RIGHT = 8;
	const THAI_DISTRIBUTED = 11;
	const TOP = 9;
};
...
class Color extends Java {
	...
	static function a(...$argv) {
		return Java(self::$_className)->a(...$argv);
	}
...
class DateTime extends Java {
	...
	static function b(...$argv) {
		return Java(self::$_className)->b(...$argv);
	}

	static function d(...$argv) {
		return Java(self::$_className)->d(...$argv);
	}

	static function g(...$argv) {
		return Java(self::$_className)->g(...$argv);
	}
...
class SubscriptionPricingPlan extends Java {
	static private $_className = "com.aspose.cells.SubscriptionPricingPlan";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
